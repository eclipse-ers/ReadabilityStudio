...
## Image Tools {#sec-image-tools}

These tools are available from the **Image** section on the **Tools** tab of the ribbon.

### Merge Images {-}

Click the `r keys('Merge Images')` button to select two or more images and combine them (horizontally or vertically) into a single image.
Click any thumbnail in the dialog to select a different image, then click **OK** to save the combined image to a new file.

### Apply Effect {-}

Click the `r keys('Apply Effect')` button to select an image and apply an effect to it (e.g., grayscale, sepia, oil painting).
Select an effect to preview it, then click **OK** to save the edited image to a new file.
...
This is useful when you want to cluster the documents in your batch into subgroups.
