...
- Write in modern C++{{< var CMAKE_CXX_STANDARD >}}, but only use features compatible with the latest *Visual Studio*, *GCC*, and *Apple Clang* releases
...
Examples of "high-level" code would be the projects, web harvester, and graphics code.
...
- Formatting code (e.g., HTML tags) should not be in translatable strings when possible
